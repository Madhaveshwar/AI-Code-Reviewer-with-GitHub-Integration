...
from ai_code_reviewer.utils.prompts import SYSTEM_SMELL_PROMPT, build_smell_prompt
from ai_code_reviewer.security_scanner import parse_json_from_llm
...
def detect_code_smells(
    ...
    try:
        ...
        try:
            ...
            from ai_code_reviewer.reviewer import handle_groq_error
